...
void AppWindow::onCreate() {
	...
	m_invoker.bindCommand((int)Action::SpawnBunny, [this]() { return new SpawnObjectCommand<Bunny>(); });
	m_invoker.bindCommand((int)Action::SpawnArmadillo, [this]() { return new SpawnObjectCommand<Armadillo>(); });

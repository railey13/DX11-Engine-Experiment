...
Cube::Cube(void* shader_byte_code, size_t size_shader) {
	vertex list[] = {
		...
		// X - Y - Z
		// FRONT FACE
		{Vector3D(-0.2f, -0.2f, -0.2f), Vector3D(1.0f, 1.0f, 1.0f), Vector3D(1.0f, 1.0f, 1.0f)}, // POS1
		{Vector3D(-0.2f, 0.2f, -0.2f),	Vector3D(1.0f, 1.0f, 1.0f), Vector3D(1.0f, 1.0f, 1.0f)}, // POS2
		{Vector3D(0.2f, 0.2f, -0.2f),	Vector3D(1.0f, 1.0f, 1.0f), Vector3D(1.0f, 1.0f, 1.0f)}, // POS3 
		{Vector3D(0.2f, -0.2f, -0.2f),	Vector3D(1.0f, 1.0f, 1.0f), Vector3D(1.0f, 1.0f, 1.0f)}, // POS4

...
void DeviceContext::setCosntantBuffer(VertexShader* vertex_shader, ConstantBuffer* constant_buffer) {
	m_device_context->VSSetConstantBuffers(0, 1, &constant_buffer->m_buffer);
}

void DeviceContext::setCosntantBuffer(PixelShader* pixel_shader, ConstantBuffer* constant_buffer) {
